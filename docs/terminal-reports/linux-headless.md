...
prove on Linux without VoiceOver, NVDA, Orca, Terminal.app, or Windows
Terminal. It does not close issues #2 or #3.
...
| VoiceOver / NVDA / Orca announcements | **Not tested** | needs a native report |
| IME composition (not paste) | **Not tested** | paste of composed text is the stand-in |
| Terminal.app / Windows Terminal clipboard policy | **Not tested** | OSC 52 depends on the emulator |
