...
```sh
# Linux
sha256sum jotline-0.9.3-py3-none-any.whl
# macOS
shasum -a 256 jotline-0.9.3-py3-none-any.whl
```

In PowerShell, run
`Get-FileHash ./jotline-0.9.3-py3-none-any.whl -Algorithm SHA256`.
...
# Linux / macOS
jotline-env/bin/python -m pip install ./jotline-0.9.3-py3-none-any.whl
...
```sh
uv tool install --force ./jotline-0.9.3-py3-none-any.whl
# Or, if installed with pipx:
pipx install --force ./jotline-0.9.3-py3-none-any.whl
jotline --version
jotline doctor
```
